...
class TimeHelperTest {
    ...
    fun testWeekdayLogic() {
        ...
        assertEquals(0,
            TimeHelper.instance.normalizeDayOfTheWeek(1,1))
        assertEquals(1,
            TimeHelper.instance.normalizeDayOfTheWeek(1,2))
        assertEquals(2,
            TimeHelper.instance.normalizeDayOfTheWeek(1,3))
        assertEquals(3,
            TimeHelper.instance.normalizeDayOfTheWeek(1,4))
        assertEquals(4,
            TimeHelper.instance.normalizeDayOfTheWeek(1,5))
        assertEquals(5,
            TimeHelper.instance.normalizeDayOfTheWeek(1,6))
        assertEquals(6,
            TimeHelper.instance.normalizeDayOfTheWeek(1,7))

        assertEquals(0,
            TimeHelper.instance.normalizeDayOfTheWeek(1,1))
        assertEquals(1,
            TimeHelper.instance.normalizeDayOfTheWeek(2,1))
        assertEquals(2,
            TimeHelper.instance.normalizeDayOfTheWeek(3,1))
        assertEquals(3,
            TimeHelper.instance.normalizeDayOfTheWeek(4,1))
        assertEquals(4,
            TimeHelper.instance.normalizeDayOfTheWeek(5,1))
        assertEquals(5,
            TimeHelper.instance.normalizeDayOfTheWeek(6,1))
        assertEquals(6,
            TimeHelper.instance.normalizeDayOfTheWeek(7,1))
    }
